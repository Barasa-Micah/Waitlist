    ...
    <span className='flex items-center'>
     ...
     {errors.lastName.message}
             ...
             <div>
                ...
                <p className='text-sm font-medium text-pink-600 text-left mt-1 mb-2'>{errors.email?.message && (
    <span className='flex items-center'>
     <ErrorSharpIcon className='mr-1' sx={{ color: pink[500], fontSize: 16, verticalAlign: 'middle' }} />
     {errors.email.message}
             ...
             <div>
                ...
                <p className='text-sm font-medium text-pink-600 text-left mt-1 mb-2'>{errors.username?.message && (
    <span className='flex items-center'>
     <ErrorSharpIcon className='mr-1' sx={{ color: pink[500], fontSize: 16, verticalAlign: 'middle' }} />
     {errors.username.message}
             ...
             <div className='relative'>
                ...
                <p className='text-sm font-medium text-pink-600 text-left mt-1 mb-2'>{errors.password?.message && (
    <span className='flex items-center'>
     <ErrorSharpIcon className='mr-1' sx={{ color: pink[500], fontSize: 16, verticalAlign: 'middle' }} />
